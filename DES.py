...
def binvalue(val, bitsize): 
    ...
    while len(binval) < bitsize:    # Appending with required number of zeros in front
        binval = "0" + binval       # Add as many 0 as needed until the size is 8n
    return binval                   # Returning binary value
